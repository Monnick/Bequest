...
namespace BackEnd.Configuration
{
    ...
    {
		public static void SeedCountries(this IApplicationBuilder app)
		{
		...
		private static void SeedCountries(DataContext context)
		{
			var countries = new[]
			{
				...
				new Country{ Name = "Congo (Democratic Republic of the)", Code ="CD" },
				...
				new Country{ Name = "Holy See", Code ="VA" },
				...
				new Country{ Name = "United Kingdom of Great Britain and Northern Ireland", Code ="GB" },
			...
			{
				if (!context.Countries.Any(c => c.Code == country.Code))
